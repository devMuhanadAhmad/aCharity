    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5"
        ...
        <div class="container pt-100 pb-50">
            ...
            <div class="section-content pt-100">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="title text-white">{{ __('Categories') }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="section-content">
                <div class="row multi-row-clearfix">
                    @foreach ($mainCategoriesWithChildren as $mainCategory)
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <h2 class="text-uppercase line-bottom-center mt-0">
                                        ...
                                        @if (config('app.locale') == 'en')
                                            {{ $mainCategory->en_title }}
                                        @else
                                            {{ $mainCategory->ar_title }}
                                        @endif
                                    </h2>
                            ...
                            @forelse ($mainCategory->subcategories as $subcategory)
                                <div class="col-sm-6 col-md-3 col-lg-3">
                                    <div class="causes bg-white maxwidth500 mb-30">
                                        ...
                                        <div
                                            class="causes-details clearfix  border-bottom-theme-color-1px p-15 pt-10 pb-10">

                                            @if (config('app.locale') == 'en')
                                                <h5 class="font-weight-600 font-16"><a
                                                        href="#">{{ $subcategory->en_name }}</a></h5>
                                                <p>{{ $subcategory->en_description }}</p>
                                            @else
                                                <h5 class="font-weight-600 font-16"><a
                                                        href="#">{{ $subcategory->ar_name }}</a></h5>
                                                <p>{{ $subcategory->ar_description }}</p>
                                            @endif
                                            <ul class="list-inline project-conditions mt-20 text-center m-0 p-10">
                                                <li class="target-fund text-theme-colored">
                                                    <strong>${{ $subcategory->price }}</strong></li>
